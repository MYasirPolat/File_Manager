...
compile:
	...
	gcc -c -I "./include" ./src/file_operations.c -o ./lib/file_operations.o
...
link:
	gcc ./lib/logger.o ./lib/file_operations.o ./lib/directory_ops.o ./lib/permissions.o ./lib/main.o -o ./bin/file_manager
